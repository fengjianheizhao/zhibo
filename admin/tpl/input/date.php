...
<div class="input">
	...
	<input style="width:350px;"  name="detail[<?=$FIELD['name']?>]" type="text" id="detail-<?=$FIELD['name']?>" value="<?=date("Y-m-d",$value)?>" <?=$FIELD['readonly']==true?"readonly=\"readonly\"":""?> <?=$FIELD['disabled']==true?"disabled=\"disabled\"":""?>/>
