...
<div id="content" class="white">
	<div class="bloc">
		...
		<div class="content">
			<form action="?m=<?=$m?>&c=ajax&a=areaedit" method="post" id="formbox" onSubmit="return ajaxSubmit(this)">
				<input  name="detail[areaid]" value="<?= $detail['areaid']?>" type="hidden"  />
				...
				<div class="input textarea">
					...
					<input  name="detail[name]" value="<?= $detail['area'] ?>" type="text" id="category-name" />
